...
const htmlPages = {
  'home.html': `<section class="page-shell" view-transition-name="page-content">
  ...
  'dashboard.html': `<section class="page-shell" view-transition-name="page-content">
  ...
  'charts.html': `<section class="page-shell" view-transition-name="page-content">
  ...
  'forms.html': `<section class="page-shell" view-transition-name="page-content">
  ...
  'tables.html': `<section class="page-shell" view-transition-name="page-content">
  ...
  'gallery.html': `<section class="page-shell" view-transition-name="page-content">
  ...
  'media.html': `<section class="page-shell" view-transition-name="page-content">
  ...
  'maps.html': `<section class="page-shell" view-transition-name="page-content">
  <div class="page-header"><h1>Maps</h1><p>Geolocation-aware location demo with live coordinate output.</p></div>
  ...
  'markdown.html': `<section class="page-shell" view-transition-name="page-content">
  ...
  'pdf.html': `<section class="page-shell" view-transition-name="page-content">
  ...
  'upload.html': `<section class="page-shell" view-transition-name="page-content">
  ...
  'three.html': `<section class="page-shell" view-transition-name="page-content">
  ...
  'webgpu.html': `<section class="page-shell" view-transition-name="page-content">
  ...
  'physics.html': `<section class="page-shell" view-transition-name="page-content">
  <div class="page-header"><h1>Physics</h1><p>A simple physics simulation rendered in a canvas element.</p></div>
  <div class="physics-card">
    <canvas id="physics-canvas" width="900" height="320"></canvas>
    <button id="physics-reset">Reset Simulation</button>
  </div>
</section>`,
  'canvas.html': `<section class="page-shell" view-transition-name="page-content">
  ...
  'browser-api.html': `<section class="page-shell" view-transition-name="page-content">
  ...
  'ai.html': `<section class="page-shell" view-transition-name="page-content">
  ...
  'settings.html': `<section class="page-shell" view-transition-name="page-content">
  ...
  'about.html': `<section class="page-shell" view-transition-name="page-content">
  ...
  '404.html': `<section class="page-shell" view-transition-name="page-content">
...
const jsPages = {
  'about.js': `export default class AboutPage {
  init() {
  ...
  'dashboard.js': `import { loadLibrary } from '../core/libraryLoader.js';
...
export default class DashboardPage {
  ...
  'charts.js': `import { loadLibrary } from '../core/libraryLoader.js';
...
export default class ChartsPage {
  ...
  'forms.js': `export default class FormsPage {
  constructor() {
  ...
  'tables.js': `export default class TablesPage {
  constructor() {
    this.rows = [
  ...
  'gallery.js': `export default class GalleryPage {
  constructor() {
  ...
  'maps.js': `export default class MapsPage {
  constructor() {
  ...
  'markdown.js': `export default class MarkdownPage {
  constructor() {
  ...
  'media.js': `export default class MediaPage {
  constructor() {
  ...
  'pdf.js': `export default class PdfPage {
  init() {
  ...
  'physics.js': `export default class PhysicsPage {
  constructor() {
    this.frame = null;
...
export default class ThreePage {
  ...
  'canvas.js': `export default class CanvasPage {
  constructor() {
    this.frame = null;
    this.angle = 0;
  ...
  'upload.js': `export default class UploadPage {
  constructor() {
  ...
  'settings.js': `import { themeManager } from '../core/themeManager.js';
...
function writeFiles() {
  ...
  Object.entries(htmlPages).forEach(([name, content]) => {
    fs.writeFileSync(path.join(htmlDir, name), content.trim() + '\n', 'utf8');
  });

  Object.entries(jsPages).forEach(([name, content]) => {
    fs.writeFileSync(path.join(jsDir, name), content.trim() + '\n', 'utf8');
  });

  console.log('Updated page HTML templates and page scripts.');
}
